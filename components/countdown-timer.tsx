  ...
  return (
    <div className="grid grid-cols-4 gap-4 max-w-2xl mx-auto bg-white">
      ...
      <div className="bg-secondary p-6 rounded-lg shadow-md text-center">
        ...
        <div className="text-accent font-medium mt-2 text-sm">{t("countdown.hours")}</div>
      </div>
      <div className="bg-secondary p-6 rounded-lg shadow-md text-center">
        <div className="text-4xl md:text-5xl font-bold text-secondary-foreground">{timeLeft.minutes}</div>
        <div className="text-accent font-medium mt-2 text-sm">{t("countdown.minutes")}</div>
      </div>
      <div className="bg-secondary p-6 rounded-lg shadow-md text-center">
        <div className="text-4xl md:text-5xl font-bold text-secondary-foreground">{timeLeft.seconds}</div>
        <div className="text-accent font-medium mt-2 text-sm">{t("countdown.seconds")}</div>
      </div>
    </div>
  )
}
