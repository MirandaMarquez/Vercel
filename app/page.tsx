    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-surface overflow-x-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 items-center justify-items-center">
            {/* Davion */}
            <div className="w-full max-w-[240px] h-[100px] md:h-[140px] flex items-center justify-center bg-surface rounded-lg shadow-sm p-2 border border-gray-100">
              <Image
