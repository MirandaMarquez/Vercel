      ...
      <section className="py-20 bg-surface overflow-x-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6 items-center justify-items-center">
            {/* Davion */}
            <div className="w-full max-w-[240px] h-[80px] md:h-[120px] lg:h-[140px] flex items-center justify-center bg-surface rounded-lg shadow-sm p-2 border border-gray-100">
              <Image
